...
const style = {
    wrapper: `pt-1`,
    searchHeader: `w-full text-black font-bold text-left flex items-center text-3xl p-4 overflow-hidden`,
...
const LocationSelector = () => {
    ...
    const { pickup, setPickup, dropoff, setDropoff } = useContext(sgContext)
